...
contract FloatMath {
   ...
   uint256 constant INV_SQRT_MAGIC =
      uint256(bytes32(0x5fffe6eb50c7b537a9cd9f02e504fcfbfd9ec519e04e8f0a29d961d2aaeb2223));
   ...
   function fromArray(uint256[3] memory _array) public pure returns (bytes32 packed) {
   ...
   function addArrays(uint256[3] memory aArray, uint256[3] memory bArray)
      internal
      pure
   ...
   function negateArray(uint256[3] memory aArray) internal pure returns (uint256[3] memory result) {
      if (aArray[0] == 0 && aArray[1] == 0 && aArray[2] == 0) {
         return aArray;
      }
   ...
   function subArrays(uint256[3] memory aArray, uint256[3] memory _bArray)
      internal
      pure
      returns (uint256[3] memory result)
   {
   ...
   function mulArrays(uint256[3] memory aArray, uint256[3] memory bArray)
      internal
      pure
      returns (uint256[3] memory result)
   {
      ...
      uint256 newSignif = 0; // Add this declaration before using it

      if (newExp > EXP_MAX) {
         // Handle overflow case by reverting with a helpful message
         revert("Exponent overflow");
      }

      // Alternative approach (uncomment to use instead of reverting):
      // if (newExp > EXP_MAX) {
      //     newExp = EXP_MAX;
   ...
   function divArrays(uint256[3] memory aArray, uint256[3] memory bArray)
      internal
      pure
      returns (uint256[3] memory result)
   {
   ...
   function divNaiveArrays(uint256[3] memory aArray, uint256[3] memory bArray)
      internal
      pure
      returns (uint256[3] memory result)
   {
   ...
   function compareArrays(uint256[3] memory aArray, uint256[3] memory bArray) internal pure returns (int8 result) {
   ...
   function compareAbsArrays(uint256[3] memory aArray, uint256[3] memory bArray) internal pure returns (int8 result) {
   ...
   function log2Array(uint256[3] memory aArray) internal pure returns (uint256[3] memory result) {
      require(aArray[0] == 0);
